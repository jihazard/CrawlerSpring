...
public class LineEngineerAppTest {
...
//			System.out.println("url :" + url.eq(i).attr("href"));
	...
	public static boolean checkStatus(String date) throws ParseException{
		...
		before7Day.setTime ( today.getTime ( ) - ( (long) 1000 * 60 * 60 * 24 * 30 ) );
     	

		System.out.println("7day befor e" + before7Day);
